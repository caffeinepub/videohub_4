...
export class Backend implements backendInterface {
    ...
    async createVideo(arg0: string, arg1: string, arg2: ExternalBlob, arg3: ExternalBlob): Promise<string> {
        if (this.processError) {
            try {
                const result = await this.actor.createVideo(arg0, arg1, await to_candid_ExternalBlob_n10(this._uploadFile, this._downloadFile, arg2), await to_candid_ExternalBlob_n10(this._uploadFile, this._downloadFile, arg3));
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async getCommentsForVideo(arg0: string): Promise<Array<Comment>> {
        if (this.processError) {
            try {
    ...
    async hasUserLikedVideo(arg0: string): Promise<boolean> {
        if (this.processError) {
            try {
                const result = await this.actor.hasUserLikedVideo(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
...
async function from_candid_record_n16(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: {
    ...
    return {
        ...
        thumbnail: await from_candid_ExternalBlob_n17(_uploadFile, _downloadFile, value.thumbnail),
